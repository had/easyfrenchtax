...
class TaxSimulator:
    ...
    def compute_net_salaries(self):
        ...
        self.state["total_net_salaries"] = incomes_1 - self.state["deduction_10p_1"] + incomes_2 - self.state[
            "deduction_10p_2"]
    ...
    def compute_tax_reductions(self):
        ...
        pme_capital_subscription_after_aug10 = min(self.state["pme_capital_subscription_7CH"],
                                                   100000 - pme_capital_subscription_before_aug10)
        self.state["pme_subscription_reduction"] = pme_capital_subscription_before_aug10 * 0.18\
                                                   + pme_capital_subscription_after_aug10 * 0.25
    ...
    def compute_social_taxes(self):
        ...
        self.state["net_social_taxes"] = round(
            so_salarycontrib_10p + so_csg + so_crds + rsu_csgcrds + rsu_social_contrib)
